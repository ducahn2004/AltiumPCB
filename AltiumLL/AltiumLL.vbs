    ...
    Do Until f.AtEndOfStream
       ...
       If lineArray(0) = "CreateFootprintInLib" Then
          ...
          If Not AddPCB Then
             ...
             If stpFileName <> vbNullString Then fso.DeleteFile("D:\Code\AltiumPCB\AltiumLL\Temp" & stpFileName)
          Else
...
Function ProcessSelectedPart(partID)
    ...
    If CheckLogin Then
        ...
        ecadModelPath = "D:\Code\AltiumPCB\AltiumLL\Temp"
...
Function ReadTXT(LineNo)
   TXTFileName = "D:\Code\AltiumPCB\AltiumLL\AltiumLL.txt"
   Set fso = CreateObject("Scripting.FileSystemObject")
...
Sub ShowImages()
    ...
    ImagePath = "D:\Code\AltiumPCB\AltiumLL\SamacSys_Images"
